import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,e}from"./app-Cs38sdJl.js";const t={},p=e(`<h2 id="项目一" tabindex="-1"><a class="header-anchor" href="#项目一"><span>项目一</span></a></h2><p>根据名称获取动漫列表</p><p>1,定义api.type.ts （定义后台接口返回的类型）</p><div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre class="language-typescript"><code>
