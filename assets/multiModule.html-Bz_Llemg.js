import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as e,c,e as a}from"./app-CORhRdYs.js";const s={},i=a(`<h2 id="_1、一个真实的多模块maven项目" tabindex="-1"><a class="header-anchor" href="#_1、一个真实的多模块maven项目"><span>1、一个真实的多模块maven项目</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ tree <span class="token parameter variable">-d</span> <span class="token parameter variable">-L</span> <span class="token number">2</span>
.———————————————————————————————————最顶级pom所在目录
├── ccs-auth
│   ├── src
│   └── target
