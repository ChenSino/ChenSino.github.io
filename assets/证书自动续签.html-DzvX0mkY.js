import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as a,e}from"./app-BMKArAfX.js";const i={},l=e(`<h3 id="场景" tabindex="-1"><a class="header-anchor" href="#场景"><span>场景</span></a></h3><p>我有一个pve虚拟机系统，需要部署ssl证书，同时我还有其他的云服务器以及内网服务器都需要证书，这些证书的根域名都是chensina.cn，而使用acme.sh申请的证书一般都是免费90天，到期就需要重新生成。重新生成后又要复制到其他远程服务器，然后重启对应的服务， 比较麻烦，所以这里写一个脚本自动完成。</p><h3 id="实现流程" tabindex="-1"><a class="header-anchor" href="#实现流程"><span>实现流程</span></a></h3><ol><li>在pve机器上写个定时脚本定时执行证书申请（配置定时任务一周一次即可）</li><li>安装证书到pve机器本地（需要重启pveproxy服务）</li><li>scp复制到其他远程服务器上</li><li>远程服务器上的服务重启（使用脚本监听证书，自动执行重启）</li></ol><h3 id="acme-sh安装使用" tabindex="-1"><a class="header-anchor" href="#acme-sh安装使用"><span>acme.sh安装使用</span></a></h3><p>略</p><h3 id="脚本" tabindex="-1"><a class="header-anchor" href="#脚本"><span>脚本</span></a></h3><h4 id="pve上的脚本" tabindex="-1"><a class="header-anchor" href="#pve上的脚本"><span>pve上的脚本</span></a></h4><p>1.脚本</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="远程服务器192-168-1-105" tabindex="-1"><a class="header-anchor" href="#远程服务器192-168-1-105"><span>远程服务器192.168.1.105</span></a></h4><ol><li>安装监听软件</li></ol><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment">#.安装inotify-tools监听证书文件变化</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,22),t=[l];function c(p,o){return n(),a("div",null,t)}const v=s(i,[["render",c],["__file","证书自动续签.html.vue"]]),m=JSON.parse('{"path":"/myserver/%E8%AF%81%E4%B9%A6%E8%87%AA%E5%8A%A8%E7%BB%AD%E7%AD%BE.html","title":"acme.sh证书自动续签","lang":"zh-CN","frontmatter":{"title":"acme.sh证书自动续签","date":"2024-11-14T00:00:00.000Z","author":"chensino","publish":true,"isOriginal":true,"description":"场景 我有一个pve虚拟机系统，需要部署ssl证书，同时我还有其他的云服务器以及内网服务器都需要证书，这些证书的根域名都是chensina.cn，而使用acme.sh申请的证书一般都是免费90天，到期就需要重新生成。重新生成后又要复制到其他远程服务器，然后重启对应的服务， 比较麻烦，所以这里写一个脚本自动完成。 实现流程 在pve机器上写个定时脚本定时...","head":[["meta",{"property":"og:url","content":"https://ChenSino.github.io/myserver/%E8%AF%81%E4%B9%A6%E8%87%AA%E5%8A%A8%E7%BB%AD%E7%AD%BE.html"}],["meta",{"property":"og:site_name","content":"ChenSino"}],["meta",{"property":"og:title","content":"acme.sh证书自动续签"}],["meta",{"property":"og:description","content":"场景 我有一个pve虚拟机系统，需要部署ssl证书，同时我还有其他的云服务器以及内网服务器都需要证书，这些证书的根域名都是chensina.cn，而使用acme.sh申请的证书一般都是免费90天，到期就需要重新生成。重新生成后又要复制到其他远程服务器，然后重启对应的服务， 比较麻烦，所以这里写一个脚本自动完成。 实现流程 在pve机器上写个定时脚本定时..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-11-14T02:10:38.000Z"}],["meta",{"property":"article:author","content":"chensino"}],["meta",{"property":"article:published_time","content":"2024-11-14T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-11-14T02:10:38.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"acme.sh证书自动续签\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2024-11-14T00:00:00.000Z\\",\\"dateModified\\":\\"2024-11-14T02:10:38.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"chensino\\"}]}"]]},"headers":[{"level":3,"title":"场景","slug":"场景","link":"#场景","children":[]},{"level":3,"title":"实现流程","slug":"实现流程","link":"#实现流程","children":[]},{"level":3,"title":"acme.sh安装使用","slug":"acme-sh安装使用","link":"#acme-sh安装使用","children":[]},{"level":3,"title":"脚本","slug":"脚本","link":"#脚本","children":[]}],"git":{"createdTime":1731550238000,"updatedTime":1731550238000,"contributors":[{"name":"ChenSino","email":"462488588@qq.com","commits":1}]},"readingTime":{"minutes":2.64,"words":793},"filePathRelative":"myserver/证书自动续签.md","localizedDate":"2024年11月14日","excerpt":"<h3>场景</h3>\\n<p>我有一个pve虚拟机系统，需要部署ssl证书，同时我还有其他的云服务器以及内网服务器都需要证书，这些证书的根域名都是chensina.cn，而使用acme.sh申请的证书一般都是免费90天，到期就需要重新生成。重新生成后又要复制到其他远程服务器，然后重启对应的服务，\\n比较麻烦，所以这里写一个脚本自动完成。</p>\\n<h3>实现流程</h3>\\n<ol>\\n<li>在pve机器上写个定时脚本定时执行证书申请（配置定时任务一周一次即可）</li>\\n<li>安装证书到pve机器本地（需要重启pveproxy服务）</li>\\n<li>scp复制到其他远程服务器上</li>\\n<li>远程服务器上的服务重启（使用脚本监听证书，自动执行重启）</li>\\n</ol>","autoDesc":true}');export{v as comp,m as data};
