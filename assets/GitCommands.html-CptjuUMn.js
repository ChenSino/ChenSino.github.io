import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,e}from"./app-B6l6YpFP.js";const t={},i=e(`<h2 id="一、善用手册" tabindex="-1"><a class="header-anchor" href="#一、善用手册"><span>一、善用手册</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ <span class="token function">git</span> <span class="token parameter variable">--help</span>
