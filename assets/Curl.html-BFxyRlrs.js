import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,o as l,c as r,a as e,b as s,d as t,e as o}from"./app-C5fiouBg.js";const c={},d=e("h2",{id:"_1、使用curl分析接口请求耗时",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_1、使用curl分析接口请求耗时"},[e("span",null,"1、使用CURL分析接口请求耗时")])],-1),u={href:"https://cizixs.com/2017/04/11/use-curl-to-analyze-request/",target:"_blank",rel:"noopener noreferrer"},p={href:"https://blog.josephscott.org/2011/10/14/timing-details-with-curl/",target:"_blank",rel:"noopener noreferrer"},m=o(`<blockquote><p>在服务器上发送请求一般用四字命令<code>curl</code>，本博客记录一下如何用curl测试接口耗时</p></blockquote><h3 id="_1-1-构造curl命令" tabindex="-1"><a class="header-anchor" href="#_1-1-构造curl命令"><span>1.1 构造curl命令</span></a></h3><p>浏览器提供了快速构建各种curl请求的方式，直接复制，有需要再编辑即可 <img src="https://ddns.chensina.cn:29000/afatpig/blog/20220812173254.png" alt="构造curl"></p><h3 id="_1-2、分析耗时" tabindex="-1"><a class="header-anchor" href="#_1-2、分析耗时"><span>1.2、分析耗时</span></a></h3><p>使用<code>curl</code>的-w选项，其手册如下：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>-w, --write-out <span class="token operator">&lt;</span>format<span class="token operator">&gt;</span>
