...
![image-20220329145737001](https://ddns.chensina.cn:29000/afatpig/blog/image-20220329145737001.png)
...
![image-20220329151313405](https://ddns.chensina.cn:29000/afatpig/blog/image-20220329151313405.png)
...
![image-20220329152103052](https://ddns.chensina.cn:29000/afatpig/blog/image-20220329152103052.png)
...
![image-20220329153946950](https://ddns.chensina.cn:29000/afatpig/blog/image-20220329153946950.png)

可以看到调用get方法获取到了caller接口实现类中的返回值

![image-20220329153915843](https://ddns.chensina.cn:29000/afatpig/blog/image-20220329153915843.png)



`java.util.concurrent.ExecutorService#submit(java.util.concurrent.Callable<T>)`源码

![image-20220329154106854](https://ddns.chensina.cn:29000/afatpig/blog/image-20220329154106854.png)
...
![image-20220329155120825](https://ddns.chensina.cn:29000/afatpig/blog/image-20220329155120825.png)

### 3.2 `java.util.concurrent.ThreadPoolExecutor`

#### 3.2.1 构造方法

![image-20220329161315724](https://ddns.chensina.cn:29000/afatpig/blog/image-20220329161315724.png)

表面上看有4个，实际上就一个在干活，最终都调用的是下面这个，无非就是传递不同的构造参数，这里点开`java.util.concurrent.Executors#newFixedThreadPool(int)`看一下就知道了

![image-20220329161738207](https://ddns.chensina.cn:29000/afatpig/blog/image-20220329161738207.png)
...
![image-20220329212937714](https://ddns.chensina.cn:29000/afatpig/blog/image-20220329212937714.png)

过了10s后，发现只有一个了，符合我们的预期

![image-20220329213033143](https://ddns.chensina.cn:29000/afatpig/blog/image-20220329213033143.png)



`java.util.concurrent.Future#get()`有说明，get是会一直等到此线程结束

![image-20220329213244994](https://ddns.chensina.cn:29000/afatpig/blog/image-20220329213244994.png)
