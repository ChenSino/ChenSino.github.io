...
![image-20220428111351818](http://ddns.chensina.cn:29000/afatpig/blog/image-20220428111351818.png)

3. 到本地IDE打开源码

![image-20220428111556978](http://ddns.chensina.cn:29000/afatpig/blog/image-20220428111556978.png)

createPDF方法空指针，那首先肯定想到的是参数htmlStr是null

4. 进入freemarkerRender方法查看，为何返回null

![image-20220428112248916](http://ddns.chensina.cn:29000/afatpig/blog/image-20220428112248916.png)
...
![image-20220428113034007](http://ddns.chensina.cn:29000/afatpig/blog/image-20220428113034007.png)

7. 源码中因为异常未指定捕获`TemplateModelException`所以`template.process(dataMap, out);`方法报错后直接返回了null，所以直接把异常捕获改成`ExcelpTion`即可

   ![image-20220428113408828](http://ddns.chensina.cn:29000/afatpig/blog/image-20220428113408828.png)
