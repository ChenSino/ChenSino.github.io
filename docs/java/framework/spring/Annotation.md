...
![Idea提示Field inject is not recommanded](http://ddns.chensina.cn:29000/afatpig/blog/20221223170907.png)

idea自动修复方法如下，正好说明了只有一个带参的构造方法时，可以省略构造方法上的@Autowired

![Idea给出的修复方法](http://ddns.chensina.cn:29000/afatpig/blog/20221223170953.png)
