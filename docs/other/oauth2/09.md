...
![图1 OAuth 2.0和OIDC的角色对应关系](https://afatpig.oss-cn-chengdu.aliyuncs.com/blog/8f794280f949862af3ebdc61d69c5fe9.png)
...
![图2 基于授权码流程的OIDC通信流程](https://afatpig.oss-cn-chengdu.aliyuncs.com/blog/23ce63497f6734dbc6dc9c5b6399c54b.png)
...
另外，在验证 JWT 合法性的时候，因为 ID 令牌本身已经被身份认证服务（OP）的密钥签名过，所以关键的一点是合法性校验时需要做签名校验。具体的加密方法和校验方法，你可以回顾下[第 4 讲。](https://chensino.github.io/other/oauth2/04.html)
...
![图3 单点登录的通信流程](https://afatpig.oss-cn-chengdu.aliyuncs.com/blog/7bf3cb13a5174f2068c916a4d1ef2748.png)
