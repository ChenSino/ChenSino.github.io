...
![img](https://ddns.chensina.cn:29000/afatpig/blog/18cd7b24ff152e28806b1176b0a560e4.png)



再使用[JWT 解析工具](http://jwt.io/)看下请求 Token 中的信息：

![img](https://ddns.chensina.cn:29000/afatpig/blog/8e4c2dd1931a31197df55cc251b2a07e.png)

可以看到，Token 中果然包含了 Token 增强器加入的 userDetails 自定义信息。如果我们把公钥粘贴到页面的话，可以看到这个 JWT 校验成功了：

![img](https://ddns.chensina.cn:29000/afatpig/blog/4d701319144d3de7c5d743f59e4991ae.png)
...
![img](https://ddns.chensina.cn:29000/afatpig/blog/2835c0d2b49ac515c9f6c537dd2f7195.png)
...
![img](https://ddns.chensina.cn:29000/afatpig/blog/81722855fd6935aea594ec62b64bf0e9.png)

这里需要注意的是，并没有提供刷新令牌。这是因为，刷新令牌用于避免访问令牌失效后需要用户再次登录的问题，而客户端授权许可类型没有用户的概念，因此没有刷新令牌，也无法注入额外的 userDetails 信息。

![img](https://ddns.chensina.cn:29000/afatpig/blog/fcf2b1c1a53ecc33d3a0abc72b6d83da.png)

也可以试一下，如果我们的授权服务器没有开启 allowFormAuthenticationForClients 参数（允许表单提交认证）的话，客户端的凭证需要通过 Basic Auth 传过去而不是通过 Post：

![img](https://ddns.chensina.cn:29000/afatpig/blog/ce391c3c93e2131e1cf8fb4e3324b66f.png)
...
![img](https://ddns.chensina.cn:29000/afatpig/blog/73c3bd926e4e350b220447cd8b97d811.png)

由于我们在数据库中设置的是禁用自动批准授权的模式，所以登录后来到了批准界面：

![img](https://ddns.chensina.cn:29000/afatpig/blog/9cac3b06b632220166d7e43607da4901.png)

点击同意后可以看到，数据库中也会产生授权通过记录：

![img](https://ddns.chensina.cn:29000/afatpig/blog/9e942cc7c22ff8b4540e9f6736d56b6f.png)
...
![img](https://ddns.chensina.cn:29000/afatpig/blog/eff235ff90aafb559d6e45b07a4d173e.png)
...
![img](https://ddns.chensina.cn:29000/afatpig/blog/ea401694bf55f83353f7db65d17ab6d7.png)
...
首先，测试一下我们的安全配置，访问 /hello 端点不需要认证可以匿名访问：![img](https://ddns.chensina.cn:29000/afatpig/blog/7646fe1e6e4cc9914f79881576126459.png)

访问 /user 需要身份认证：

![img](https://ddns.chensina.cn:29000/afatpig/blog/3b22a89392c92187960aecd4bc3cf8f6.png)
...
![img](https://ddns.chensina.cn:29000/afatpig/blog/0606fbb094de245d346ed17d9yycd6d5.png)

以 POST 方式访问 http://localhost:8081/user/，显然是失败的：

![img](https://ddns.chensina.cn:29000/afatpig/blog/a71bcef74da7577aa1529bf2d9546588.png)
...
![img](https://ddns.chensina.cn:29000/afatpig/blog/a754a6fdcb9666e07f1b820052a4e2fc.png)
...
![img](https://ddns.chensina.cn:29000/afatpig/blog/05b76f316304e3ef2d1494bae501c381.png)

登录后显示了当前用户名和权限：

![img](https://ddns.chensina.cn:29000/afatpig/blog/7d24bc73267506c15f9feyy546557237.png)

我们再启动另一个客户端网站，端口改为 8083，然后访问同样的地址：

![img](https://ddns.chensina.cn:29000/afatpig/blog/7a50619ace3e40c8ff7c0aa860f11246.png)
...
![img](https://ddns.chensina.cn:29000/afatpig/blog/016f28b7161d2c600197aa2392b0de27.png)
...
![img](https://ddns.chensina.cn:29000/afatpig/blog/yy2bca66c45cefa56d2d727c3a136a84.png)
