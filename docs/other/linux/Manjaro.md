...
![image-20220322171440300](https://ddns.chensina.cn:2032/afatpig/blog/image-20220322171440300.png)
...
5. 在日志中找error
   ![image-20220322171948840](https://ddns.chensina.cn:2032/afatpig/blog/image-20220322171948840.png)
6. 报错很明显了是mysqlroute的日志切割失败了。
7. logrotate其实是被很多程序都使用了，其配置文件在/etc/logrotate.d下
   ![image-20220322172023905](https://ddns.chensina.cn:2032/afatpig/blog/image-20220322172023905.png)
...
![image-20220322172038617](https://ddns.chensina.cn:2032/afatpig/blog/image-20220322172038617.png)
...
![image-20220418155819498](https://ddns.chensina.cn:2032/afatpig/blog/image-20220418155819498.png)

![image-20220418155847045](https://ddns.chensina.cn:2032/afatpig/blog/image-20220418155847045.png)

![image-20220418155927678](https://ddns.chensina.cn:2032/afatpig/blog/image-20220418155927678.png)

![image-20220418155956979](https://ddns.chensina.cn:2032/afatpig/blog/image-20220418155956979.png)

### 4、设置yakuake提示没有权限修改文件

1. 修改yakuake的文字大小

![image-20220419110311199](https://ddns.chensina.cn:2032/afatpig/blog/image-20220419110311199.png)

![image-20220419110401735](https://ddns.chensina.cn:2032/afatpig/blog/image-20220419110401735.png)
...
![image-20220502211444881](https://ddns.chensina.cn:2032/afatpig/blog/image-20220502211444881.png)
...
![20231013103250](https://ddns.chensina.cn:2032/afatpig/blog/20231013103250.png)
...
![20240416112834](https://ddns.chensina.cn:2032/afatpig/blog/20240416112834.png)

解决方法：
在remmina设置——高级——画质，选择最好（最慢）就可以了

![20240416112927](https://ddns.chensina.cn:2032/afatpig/blog/20240416112927.png)

### 13、manjaro-kde下idea新版本UI问题

新版本IDEA的UI在manjaro-kde下显示没有使用KDE桌面设置的样式，
![20240808112352](https://ddns.chensina.cn:2032/afatpig/blog/20240808112352.png)

解决方案如下：
![20240808112509](https://ddns.chensina.cn:2032/afatpig/blog/20240808112509.png)

设置后重启idea，效果如下，终于和我设置的样式一致了：
![20240808112611](https://ddns.chensina.cn:2032/afatpig/blog/20240808112611.png)

### 14、GTK3主题设置

gtk开发的软件在kde桌面下，默认的窗口样式不好看，设置好全局主题后对GTK软件是不生效的，需要单独设置GTK3主题，在kde桌面下，右键点击桌面，选择设置，选择主题，选择GTK3主题，有的主题会专门提供GTK，
设置方法如下：
![20240815143416](https://ddns.chensina.cn:2032/afatpig/blog/20240815143416.png)

下载对应主题的gtk包，然后选择应用，当然有的主题作者没有提供gtk包，那就随便选择一个其他主题的gtk包就行了，
![20240815143437](https://ddns.chensina.cn:2032/afatpig/blog/20240815143437.png)
...
![](https://ddns.chensina.cn:2032/afatpig/blog/2025-03-05_17-21.png)

### 17、flameshot在wayland显示环境，多屏截图问题

参考如下设置：
![](https://ddns.chensina.cn:2032/afatpig/blog/2025-03-06_09-39.png)