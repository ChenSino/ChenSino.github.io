...
![image-20220723162517914](http://ddns.chensina.cn:29000/afatpig/blog/image-20220723162517914.png)
...
2. 按照提示，先`commit`本地修改，然后再次执行pull操作，得到如下丑陋的提交记录。此时本地`commit`记录便会显示如下的丑陋的`commit`记录。由于发生了冲突，但是由于是修改的不同行，git直接帮我们把本地修改和远程修改直接合并了，并产生了一个新的提交节点 Merge branch.....
   ...
   ![img](http://ddns.chensina.cn:29000/afatpig/blog/clipboard.png)
...
![image-20220723172630686](http://ddns.chensina.cn:29000/afatpig/blog/image-20220723172630686.png)
...
![image-20220723173039634](http://ddns.chensina.cn:29000/afatpig/blog/image-20220723173039634.png)

点击Merge,选择手动合并冲突的代码。此时也会产生一个合并节点。

![image-20220723173207361](http://ddns.chensina.cn:29000/afatpig/blog/image-20220723173207361.png)
...
![image-20220726104412089](http://ddns.chensina.cn:29000/afatpig/blog/image-20220726104412089.png)
...
![image-20220726105156403](http://ddns.chensina.cn:29000/afatpig/blog/image-20220726105156403.png)

![image-20220726105424098](http://ddns.chensina.cn:29000/afatpig/blog/image-20220726105424098.png)
